...
```
`<Action>`: принимает следующие значения
* "CrossStatus" - Статус (вкл/выкл) отображение креста, согласно сумме всех примененных настроек
  * `<Param>` - bool или соответствующее числовое значение. 
  * Если задан, то изменяется текущее значение и возвращает новое значние.
  * Если не задан, возвращает текущее значение. 
* "CrossType" - Тип отображение креста, согласно сумме всех примененных настроек
